                            ...
                            <tr>
                                ...
                                <td class="align-middle d-flex ml-5" height="65">
                                    ...
                                    @isset($reminders)
                                        ...
                                        @isset($debtorReminderId)


                                            @if ($debtorReminderId == $debtor->id)
                                                <div class="dropdown dropstart col mt-2 col" style="display:flex;">
                                                    <form action="{{ route("reminders.get", $debtorReminderId) }}" method="POST">
                                                        @csrf
                                            ...
                                            @else
                                                <form action="{{ route("reminder.form", $debtor->id) }}" method="POST">
                                                    @csrf
